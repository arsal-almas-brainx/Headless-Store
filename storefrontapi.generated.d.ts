...
export type CategoryCollectionByHandleQueryVariables = StorefrontAPI.Exact<{
  handle: StorefrontAPI.Scalars['String']['input'];
  country?: StorefrontAPI.InputMaybe<StorefrontAPI.CountryCode>;
  language?: StorefrontAPI.InputMaybe<StorefrontAPI.LanguageCode>;
}>;

export type CategoryCollectionByHandleQuery = {
    ...
    Pick<StorefrontAPI.Collection, 'id' | 'title' | 'handle'> & {
      products: {
        nodes: Array<
          Pick<
            StorefrontAPI.Product,
            'id' | 'title' | 'publishedAt' | 'handle' | 'tags'
          > & {
            variants: {
              nodes: Array<
                Pick<
...
interface GeneratedQueryTypes {
  '#graphql\n  query categoryCollectionByHandle(\n    $handle: String!\n    $country: CountryCode\n    $language: LanguageCode\n  ) @inContext(country: $country, language: $language) {\n    collection(handle: $handle) {\n      id\n      title\n      handle\n      image {\n        altText\n        width\n        height\n        url\n      }\n    }\n  }\n': {
    return: CategoryCollectionByHandleQuery;
    variables: CategoryCollectionByHandleQueryVariables;
  };
